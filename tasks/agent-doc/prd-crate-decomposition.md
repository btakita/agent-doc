...
| Queue syntax, scheduling, and drainability | `agent-doc-queue` | Active. Pure queue parsing, id-backed `do #id` directive target extraction, preemption/edit-owner rules, queue-continuation drainability/noise/context-reset policy, and continuation guidance wording live here; orchestration keeps snapshot, marker, controller-state, and file-IO adapters. |
