...
//! (Wave 5 / `#bjrv`).
//!
//! Thin re-export shim. All `agent_doc_core::project_config::*` call sites continue to resolve.
...
// `agent_doc_core::project_config::*` in tests, so the non-test bin build sees this
