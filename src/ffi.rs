...
/// fresh one at the end of the exchange component, preserving the visible
/// ` (HEAD)` heading affordance in the user-facing document state. Returns the
/// document unchanged if no exchange component exists.
///
/// # Safety
///
/// `doc` must be a valid, NUL-terminated UTF-8 string.
