...
class AgentDocPopupAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val group = DefaultActionGroup().apply {
            ...
            add(ActionManager.getInstance().getAction("AgentDoc.FixDocument"))
            ...
            addSeparator()
            add(ActionManager.getInstance().getAction("AgentDoc.ShowSessionStatus"))
            add(ActionManager.getInstance().getAction("AgentDoc.RestartSession"))
            add(ActionManager.getInstance().getAction("AgentDoc.ClearSessionContext"))
            add(ActionManager.getInstance().getAction("AgentDoc.CopySessionDiagnostics"))
            addSeparator()
