...
- Exact-visible provisioning effects must consume the controller's generation-fenced actor bindings before any registry/content fallback. If the routed actor already owns a live pane, an unrelated actor occupying the desired window must not be positionally relabeled as that routed document.
