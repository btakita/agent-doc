...
[104] route_dispatch_only_submit_unproven file=tasks/b.md pane=%2 harness=opencode delivery=direct_pane_submit submit_mode=tmux_literal_text_enter_key proof=accepted proof_scope=accepted_only timeout_secs=10
