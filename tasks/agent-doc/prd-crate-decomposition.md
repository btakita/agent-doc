...
| SQLite-backed persistence | `agent-doc-sqlite` | Active. Actor storage record/state types live here and are imported directly; orchestration must not re-export them through `session_actor`. |
