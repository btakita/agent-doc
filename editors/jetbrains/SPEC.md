...
- Selection settling reads visible membership from each restored editor window rather than
  ...
  geometry.
- Markdown `fileOpened` is also a visible-surface source edge. IDEA may restore split
